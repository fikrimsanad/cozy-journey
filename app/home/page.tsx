...
function HomePage() {
  return (
    <div className="">
      <div className="pt-48 bg-[url(/hero-makkah.png)] bg-contain bg-no-repeat">
        <div className="space-y-8 grid grid-cols-1 place-items-center text-center">
      ...
      <div className="text-center md:py-20 space-y-8 md:mt-32">
        <h2 className="font-bold text-3xl md:text-5xl">
          Membangun Jembatan
          <span className="font-bold text-3xl md:text-5xl text-green-700 ml-3">
            Pendidikan Global
          </span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-6 px-8 py-10">
        <div className="bg-black h-60 w-full"></div>
        <div className="bg-black h-60 w-full"></div>
        <div className="bg-black h-60 w-full"></div>
      </div>
      <div className="text-center py-28 space-y-8 mt-48">
        ...
        <p className="font-light text-sm text-gray-400 md:mx-96">
      ...
      <div className="bg-green-700 w-full md:grid md:grid-cols-4 grid-cols-1 gap-10 py-6 px-12">
